...
import {
  ...
  LayoutDashboard, ShoppingCart, BarChart3, Briefcase, UserCog, Calendar, ShoppingBag, KeyRound,
} from 'lucide-react';
    ...
    pages: [
      ...
      },
      {
        ...
        steps: [
          ...
          '本人がパスワードを忘れた場合は、ログイン画面の「パスワードをお忘れの方」から自分で再設定できる（下記「ログイン／パスワード再設定」を参照）。管理者による代理変更は必須ではない。',
        ],
