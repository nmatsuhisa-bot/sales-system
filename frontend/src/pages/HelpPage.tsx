    ...
    pages: [
      ...
      },
      {
        ...
        steps: [
          ...
          '一覧上部で「全種別／工番／単番」の絞り込みと、並び順（直近の更新順／案件ID順）を切り替えられる。既定は直近の更新順。',
          '案件ID・子IDの青文字をクリックすると詳細モーダルが開き、基本情報・取引先・金額・日程・紐付いている見積・備考をまとめて確認できる（読み取り専用）。モーダルの「編集する」から編集画面へ、Escまたは背景クリックで閉じる。',
        ],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        note: '施工部門のユーザーは閲覧のみ（「閲覧のみ」表示）。編集は管理者と他部門のみ可能です。参加者のまとまりは予定を作ったときのグループIDで判定します。グループIDを持たない古い予定は、同じ日付・時間帯・内容の行を同じ予定とみなします。',
      },
      {
